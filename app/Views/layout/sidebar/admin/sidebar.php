        ...
        <ul class="menu bg-white min-h-full w-80 px-4 py-5">
            ...
            <li class="list-menu <?= ($menu === 'dashboard') ? 'active' : '' ?>">
                <a href="<?= base_url('/admin/dashboard') ?>">
                    <div class="flex flex-row items-center">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="me-2">
            ...
            <li class="list-menu <?= ($menu === 'supplier') ? 'active' : '' ?>">
                <a href="<?= base_url('/admin/supplier') ?>">
                    <div class="flex flex-row items-center">
                        <svg width="22" height="22" viewBox="0 0 21 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="me-2">
            ...
            <li class="list-menu <?= ($menu === 'user') ? 'active' : '' ?>">
                <a href="<?= base_url('/admin/user')  ?>">
                    <div class="flex flex-row items-center">
                        <svg width="22" height="22" viewBox="0 0 24 19" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="me-2">
            ...
            <div class="mt-auto">
                <hr class="mb-5 mt-3" style="color: var(--shaded-white)">
