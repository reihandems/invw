            ...
            <li class="list-menu <?= ($menu === 'dashboard') ? 'active' : '' ?>">
                <a href="<?= base_url('/admin/dashboard') ?>">
                    <div class="flex flex-row items-center">
                        ...
                        <p class="self-center text-sm">Dashboard</p>
                    </div>
                </a>
            </li>
            <li class="list-menu <?= ($menu === 'barang') ? 'active' : '' ?>">
                <a href="<?= base_url('/admin/barang') ?>">
                    <div class="flex flex-row items-center">
                        ...
                        <p class="self-center text-sm">Data Barang</p>
                    </div>
                </a>
            </li>
            <li class="list-menu <?= ($menu === 'supplier') ? 'active' : '' ?>">
                <a href="<?= base_url('/admin/supplier') ?>">
                    <div class="flex flex-row items-center">
                        ...
                        <p class="self-center text-sm">Data Supplier</p>
                    </div>
                </a>
            </li>
            <li class="list-menu <?= ($menu === 'user') ? 'active' : '' ?>">
                <a href="<?= base_url('/admin/user')  ?>">
                    <div class="flex flex-row items-center">
                        ...
                        <p class="self-center text-sm">Data User</p>
                    </div>
                </a>
            </li>
            <li class="list-menu <?= ($menu === 'gudang') ? 'active' : '' ?>">
                <a href="<?= base_url('/admin/gudang')  ?>">
                    <div class="flex flex-row items-center">
                        ...
                        <p class="self-center text-sm">Data Gudang</p>
                    </div>
                </a>
            </li>
            <li class="list-menu <?= ($menu === 'rak') ? 'active' : '' ?>">
                <a href="<?= base_url('/admin/rak')  ?>">
                    <div class="flex flex-row items-center">
                        ...
                        <p class="self-center text-sm">Data Rak</p>
                    </div>
                </a>
            </li>
            <li class="list-menu <?= ($menu === 'laporan') ? 'active' : '' ?>">
                <a href="<?= base_url('/admin/laporan')  ?>">
                    <div class="flex flex-row items-stretch">
                        ...
                        <p class="self-center text-sm">Laporan</p>
                    </div>
                </a>
            </li>
            <div class="mt-auto">
