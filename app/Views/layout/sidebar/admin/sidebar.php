...
<div class="drawer lg:drawer-open col-span-12 md:col-span-3 h-full" style="background-color: var(--background-color);">
    ...
    <div class="drawer-content flex flex-col">
        ...
        <!-- Sidebar -->
        <div class="sidebar shadow-md font-bold p-8 h-full hidden md:block" style="background-color: var(--secondary-color);">
            ...
            <ul>
                ...
                <li class="list-menu <?= ($menu === 'barang') ? 'active' : '' ?>">
                    <a href="<?= base_url('/admin/barang') ?>">
                        <div class="flex flex-row items-center">
                            ...
                            <p class="self-center text-base">Data Barang</p>
                        </div>
                    </a>
                </li>
                <li class="list-menu <?= ($menu === 'supplier') ? 'active' : '' ?>">
                    <a href="<?= base_url('/admin/supplier') ?>">
                        <div class="flex flex-row items-center">
                            <svg width="28" height="28" viewBox="0 0 21 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="me-2">
                            ...
                            <p class="self-center text-base">Data Supplier</p>
                        </div>
                    </a>
                </li>
                <li class="list-menu <?= ($menu === 'user') ? 'active' : '' ?>">
                    <a href="<?= base_url('/admin/user')  ?>">
                        <div class="flex flex-row items-center">
                            <svg width="28" height="28" viewBox="0 0 24 19" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="me-2">
                            ...
                            <p class="self-center text-base">Data User</p>
                        </div>
                    </a>
                </li>
                <li class="list-menu <?= ($menu === 'gudang') ? 'active' : '' ?>">
                    <a href="<?= base_url('/admin/gudang')  ?>">
                        <div class="flex flex-row items-center">
                            ...
                            <p class="self-center text-base">Data Gudang</p>
                        </div>
                    </a>
                </li>
                <li class="list-menu <?= ($menu === 'rak') ? 'active' : '' ?>">
                    <a href="<?= base_url('/admin/rak')  ?>">
                        <div class="flex flex-row items-center">
                            ...
                            <p class="self-center text-base">Data Rak</p>
                        </div>
                    </a>
                </li>
    ...
    <div class="drawer-side w-full md:hidden">
        ...
        <ul class="menu p-0">
            <!-- Sidebar -->
            <div class="sidebar shadow-md font-bold block p-8 h-full" style="background-color: var(--secondary-color);">
                <div class="flex flex-row items-stretch">
                    <img src="<?= base_url('assets/img/logo.svg') ?>" alt="" class="me-2">
                    <h3 class="self-center" style="color: var(--primary-color)">INVWM</h3>
                </div>
