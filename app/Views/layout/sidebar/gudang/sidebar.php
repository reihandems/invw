        ...
        <div class="sidebar shadow-md font-bold p-8 
            ...
            <ul>
                ...
                <li class="list-menu <?= ($menu === 'pr') ? 'active' : '' ?>">
                    <a href="<?= base_url('/gudang/purchase-request') ?>">
                        <div class="flex flex-row items-center">
                ...
                <li class="list-menu <?= ($menu === 'po') ? 'active' : '' ?>">
                    <a href="<?= base_url('/gudang/purchase-order') ?>">
                        <div class="flex flex-row items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="me-2">
                ...
                <li class="list-menu <?= ($menu === 'barang_masuk') ? 'active' : '' ?>">
                    <a href="<?= base_url('/gudang/barang-masuk') ?>">
                        <div class="flex flex-row items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="me-2">
                            <path d="M21.706 5.292L18.707 2.293C18.5195 2.10545 18.2652 2.00006 18 2H6C5.73481 2.00006 5.48049 2.10545 5.293 2.293L2.294 5.292C2.20084 5.38487 2.12691 5.49522 2.07646 5.61671C2.02601 5.7382 2.00003 5.86845 2 6V19C2 20.103 2.897 21 4 21H20C21.103 21 22 20.103 22 19V6C22 5.86845 21.974 5.7382 21.9235 5.61671C21.8731 5.49522 21.7992 5.38487 21.706 5.292ZM6.414 4H17.586L18.586 5H5.414L6.414 4ZM12 18L7 13H10V10H14V13H17L12 18Z" />
                            </svg>
                            <p class="self-center text-base">Barang Masuk</p>
                        </div>
                    </a>
                </li>
                <li class="list-menu <?= ($menu === 'barang_keluar') ? 'active' : '' ?>">
                    <a href="<?= base_url('/gudang/barang-keluar') ?>">
                        <div class="flex flex-row items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="me-2">
                            <path d="M21.706 5.292L18.707 2.293C18.5195 2.10545 18.2652 2.00006 18 2H6C5.73481 2.00006 5.48049 2.10545 5.293 2.293L2.294 5.292C2.20084 5.38487 2.12691 5.49522 2.07646 5.61671C2.02601 5.7382 2.00003 5.86845 2 6V19C2 20.103 2.897 21 4 21H20C21.103 21 22 20.103 22 19V6C22 5.86845 21.974 5.7382 21.9235 5.61671C21.8731 5.49522 21.7992 5.38487 21.706 5.292ZM6.414 4H17.586L18.586 5H5.414L6.414 4ZM14 14V17H10V14H7L12 9L17 14H14Z" />
                            </svg>
                            </svg>
                            <p class="self-center text-base">Barang Keluar</p>
                        </div>
                    </a>
                </li>
                <li class="list-menu <?= ($menu === 'stok') ? 'active' : '' ?>">
                    <a href="<?= base_url('/gudang/stok') ?>">
                        <div class="flex flex-row items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="me-2">
                            <path d="M2 3H22V7H2V3ZM19 8H3V19C3 19.5304 3.21071 20.0391 3.58579 20.4142C3.96086 20.7893 4.46957 21 5 21H19C19.5304 21 20.0391 20.7893 20.4142 20.4142C20.7893 20.0391 21 19.5304 21 19V8H19ZM16 14H8V12H16V14Z" />
                            </svg>
                            <p class="self-center text-base">Stok Barang</p>
                        </div>
                    </a>
                </li>
